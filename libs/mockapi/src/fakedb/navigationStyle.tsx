...
export type SideBarImageType = { image: string; id: number };
export const sidebarBgImages: SideBarImageType[] = [
  {
    id: 1,
...
export type MenuStyleType = { image: string; alias: MenuStyle; id: number };
export const menuStyles: MenuStyleType[] = [
  {
    id: 1,
...
export const sidebarColors = [
  ...
  },
  {
    ...
    sidebarMenuSelectedBgColor: '#f1f1f1',
...
export type LayoutTypesProps = { image: string; alias: LayoutType; id: number };
export const layoutTypes: LayoutTypesProps[] = [
  {
    id: 1,
