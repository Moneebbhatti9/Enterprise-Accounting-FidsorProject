...
import { Body, TopBar, ExportDropDown } from './styles/AgedPayablesStyles';
import IncomeCustomerGrid from './components/AgedPayablesGrid';
  ...
  return (
    <Body>
      <Header
        ...
        messageId="reports.vendors.agedpayables"
      />
      <TopBar>
        <Menu
          id="dropdown-menu"
