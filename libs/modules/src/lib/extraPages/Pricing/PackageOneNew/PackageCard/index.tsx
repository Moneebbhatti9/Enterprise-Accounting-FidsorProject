...
const PackageCard = ({ billingFormat, pricing }: Props) => {
  ...
  const handleButtonClick = () => {
    ...
    localStorage.setItem('selectedPackageTitle', pricing.title);
    localStorage.setItem('selectedPackagePrice', String(pricing.price));
    localStorage.setItem('selectedBillingFormat', billingFormat);
