...
import { Container, Label } from '../styles/FilterStyle';
...
import { CreateButton } from '../styles/InvoiceStyle';
    ...
    <Container>
      <Grid container spacing={2}>
        <Grid item xs={12} md={6} lg={2}>
          <Stack width={'100%'}>
            <Label>{<IntlMessages id="common.estimate.customer" />}</Label>
        ...
        <Grid item xs={12} md={6} lg={2}>
          <Stack width={'100%'}>
            <Label>{<IntlMessages id="common.estimate.status" />}</Label>
        ...
        <Grid item xs={12} md={6} lg={2}>
          <Stack width={'100%'} className={dateStyle.pickerInput}>
            <Label>{<IntlMessages id="common.invoiceDate" />}</Label>
        ...
        <Grid item xs={12} md={6} lg={2}>
          <Stack width={'100%'} className={dateStyle.pickerInput}>
            <Label>{<IntlMessages id="common.dueDate" />}</Label>
            <LocalizationProvider dateAdapter={AdapterDayjs}>
              <DatePicker sx={{ backgroundColor: 'white' }} />
            </LocalizationProvider>
          </Stack>
        ...
        <Grid item xs={12} md={6} lg={2}>
          <Stack width={'100%'}>
            <Label>{<IntlMessages id="invoice.number" />}</Label>
            <SearchBar />
          </Stack>
        </Grid>
        <Grid item xs={12} md={6} lg={2}>
