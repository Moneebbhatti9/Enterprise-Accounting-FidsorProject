...
const InvoicesPayableToYou = ({ dealsTableData = [] }: Props) => {
      ...
      title={
        <Box sx={{ display: 'flex', alignItems: 'center' }}>
          <Typography
            ...
            component="h3"
          >
            {messages['dashboard.invoicesPayable'] as string}
          </Typography>
        </Box>
      }
...
export default InvoicesPayableToYou;
