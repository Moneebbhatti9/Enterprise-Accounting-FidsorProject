    ...
    >
      <StateWrapper color={data.color}>
        ...
        <div className="state-content">
          ...
          >
            <Typography
              sx={{
                ...
                whiteSpace: 'nowrap',
                width: '100%',
                fontWeight: Fonts.SEMI_BOLD,fontSize:'16px',
              }}
              variant="h2"
              component="h2"
            >
          ...
          >
            <Box component="span" className="state-growth" style={{fontSize:'12px'}}>
              {data.growth}
            ...
            <div>
              <Typography
                variant="body2"
                sx={{ color: 'text.secondary', whiteSpace: 'nowrap' ,fontSize:'10px'}}
              >Total
              </Typography>
            </div>
          </Box>
