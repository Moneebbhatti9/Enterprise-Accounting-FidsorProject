...
const tabs = [
  {
    link: 'accounting/chartofaccounts/all-account',
    icon: <MdAccountCircle />,
    name: <IntlMessages id="chartOfAccountApp.all" />,
  },
  {
  ...
  return (
    <>
      <AppAnimate animation="transition.slideDownIn" delay={300}>
        ...
        >
          {messages['chartOfAccountApp.account'] as string}
        </Box>
      </AppAnimate>
      <TabsWrapper key="2">
              ...
              <Tab
                ...
                label={
                  ...
                  >
                    {tab.name}
                    {index !== 0 && index !== 6 && (
                      <Badge color="primary" badgeContent={100}></Badge>
                    )}
                  </Stack>
                }
                icon={tab.icon}
